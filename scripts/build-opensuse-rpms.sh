...
OS_DIR="$ROOT_DIR/opensuse"
SPECS_DIR="$OS_DIR/specs"
RPM_REPO_DIR="$ROOT_DIR/repo/opensuse"
SOURCES_DIR="$OS_DIR/.sources"
CACHE_DIR="$OS_DIR/.build-cache"
...
# PAD6-DEV pipa/7.1.7-Stable + config + DTB/hex.h fixes.
